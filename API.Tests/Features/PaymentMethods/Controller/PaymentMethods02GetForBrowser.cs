...
namespace PaymentMethods {
    ...
    public class PaymentMethods02GetForBrowser : IClassFixture<AppSettingsFixture> {
        ...
        public async Task Active_Users_Can_Get_For_Browser(Login login) {
            ...
            var records = JsonSerializer.Deserialize<List<PaymentMethodBrowserListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
