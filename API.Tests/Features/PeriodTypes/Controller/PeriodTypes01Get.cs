...
namespace PeriodTypes {
    ...
    [Collection("Sequence")]
    public class PeriodTypes01Get : IClassFixture<AppSettingsFixture> {
        ...
        public PeriodTypes01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Admins_Can_List() {
            ...
            var records = JsonSerializer.Deserialize<List<PeriodTypeListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
