...
namespace PeriodTypes {
    ...
    [Collection("Sequence")]
    public class PeriodTypes03GetById : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/periodTypes/1";
        private readonly string _notFoundUrl = "/periodTypes/9999";

        #endregion

        public PeriodTypes03GetById(AppSettingsFixture appsettings) {
