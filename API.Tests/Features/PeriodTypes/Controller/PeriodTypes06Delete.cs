...
namespace PeriodTypes {
    ...
    [Collection("Sequence")]
    public class PeriodTypes06Delete : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/periodTypes/3";
        private readonly string _inUseUrl = "/periodTypes/1";
        private readonly string _notFoundUrl = "/periodTypes/9999";

        #endregion

        public PeriodTypes06Delete(AppSettingsFixture appsettings) {
