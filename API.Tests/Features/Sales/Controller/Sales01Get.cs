...
namespace Sales {
    ...
    [Collection("Sequence")]
    public class Sales01Get : IClassFixture<AppSettingsFixture> {
        ...
        public Sales01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Active_Users_Can_List(Login login) {
            ...
            var records = JsonSerializer.Deserialize<List<SaleListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
