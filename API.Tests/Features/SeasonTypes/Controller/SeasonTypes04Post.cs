...
namespace SeasonTypes {
    ...
    [Collection("Sequence")]
    public class SeasonTypes04Post : IClassFixture<AppSettingsFixture> {
        ...
        public SeasonTypes04Post(AppSettingsFixture appsettings) {
        ...
        [Theory]
        [ClassData(typeof(CreateValidSeasonType))]
        ...
        [Theory]
        [ClassData(typeof(CreateValidSeasonType))]
        public async Task Simple_Users_Can_Not_Create(TestSeasonType record) {
            await Forbidden.Action(_httpClient, _baseUrl, _url, _actionVerb, "simpleuser", Helpers.SimpleUserPassword(), record);
        }

        [Theory]
        [ClassData(typeof(CreateValidSeasonType))]
        public async Task Admins_Can_Create_When_Valid(TestSeasonType record) {
