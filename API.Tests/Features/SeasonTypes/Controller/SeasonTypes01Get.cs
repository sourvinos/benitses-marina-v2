...
namespace SeasonTypes {
    ...
    [Collection("Sequence")]
    public class SeasonTypes01Get : IClassFixture<AppSettingsFixture> {
        ...
        public SeasonTypes01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Admins_Can_List() {
            ...
            var records = JsonSerializer.Deserialize<List<SeasonTypeListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
