...
namespace SeasonTypes {
    ...
    [Collection("Sequence")]
    public class SeasonTypes03GetById : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/seasonTypes/1";
        private readonly string _notFoundUrl = "/seasonTypes/9999";

        #endregion

        public SeasonTypes03GetById(AppSettingsFixture appsettings) {
