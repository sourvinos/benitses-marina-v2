...
namespace Items {
    ...
    [Collection("Sequence")]
    public class Items02GetGetById : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/items/getById/1";
        private readonly string _notFoundUrl = "/items/getById//9999";

        #endregion

        public Items02GetGetById(AppSettingsFixture appsettings) {
