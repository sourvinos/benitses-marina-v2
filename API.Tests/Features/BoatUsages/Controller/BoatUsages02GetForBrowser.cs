...
namespace BoatUsages {
    ...
    [Collection("Sequence")]
    public class BoatUsages02GetForBrowser : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/boatUsages/getForBrowser";

        #endregion

        public BoatUsages02GetForBrowser(AppSettingsFixture appsettings) {
