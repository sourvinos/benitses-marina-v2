...
namespace BoatUsages {
    ...
    [Collection("Sequence")]
    public class BoatUsages03GetById : IClassFixture<AppSettingsFixture> {
        ...
        private readonly string _url = "/boatUsages/1";
        private readonly string _notFoundUrl = "/boatUsages/9999";

        #endregion

        public BoatUsages03GetById(AppSettingsFixture appsettings) {
