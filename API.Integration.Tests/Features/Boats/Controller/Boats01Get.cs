...
namespace Boats {
    ...
    [Collection("Sequence")]
    public class Boats01Get : IClassFixture<AppSettingsFixture> {
        ...
        public Boats01Get(AppSettingsFixture appsettings) {
        ...
        public async Task Active_Users_Can_List(Login login) {
            ...
            var records = JsonSerializer.Deserialize<List<BoatListVM>>(await actionResponse.Content.ReadAsStringAsync(), new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
