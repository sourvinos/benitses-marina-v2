...
namespace API.Features.PeriodTypes {
    ...
    public class PeriodTypesController(IPeriodTypeRepository repo, IPeriodTypeValidation validation) : ControllerBase {

        #region variables

        private readonly IPeriodTypeRepository repo = repo;
        private readonly IPeriodTypeValidation validation = validation;
        ...
        public async Task<ResponseWithBody> GetByIdAsync(int id) {
            ...
            if (x != null) {
                return new ResponseWithBody {
                    ...
                    Body = PeriodTypeMappings.DomainToDto(x),
