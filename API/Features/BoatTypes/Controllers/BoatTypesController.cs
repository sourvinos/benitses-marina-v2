...
namespace API.Features.BoatTypes {
    ...
    public class BoatTypesController : ControllerBase {
        ...
        public BoatTypesController(IBoatTypeRepository boatTypeRepo, IBoatTypeValidation BoatTypeValidation) {
        ...
        public async Task<ResponseWithBody> GetByIdAsync(int id) {
            ...
            if (x != null) {
                return new ResponseWithBody {
                    ...
                    Body = BoatTypeMappings.DomainToDto(x)
                };
            } else {
        ...
        public ResponseWithBody Post([FromBody] BoatTypeWriteDto boatType) {
            ...
            if (x == 200) {
                var z = boatTypeRepo.Create((BoatType)boatTypeRepo.AttachMetadataToPostDto(BoatTypeMappings.DtoToDomail(boatType)));
                return new ResponseWithBody {
                    Code = 200,
        ...
        public async Task<ResponseWithBody> Put([FromBody] BoatTypeWriteDto boatType) {
            ...
            if (x != null) {
                ...
                if (z == 200) {
                    boatTypeRepo.Update((BoatType)boatTypeRepo.AttachMetadataToPostDto(BoatTypeMappings.DtoToDomail(boatType)));
                    return new ResponseWithBody {
                        Code = 200,
                        Icon = Icons.Success.ToString(),
